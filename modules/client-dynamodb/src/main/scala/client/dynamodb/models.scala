...
object TransactGetItem {
  def apply(
    ...
    js.Dynamic
      .literal(Get = Get.asInstanceOf[js.Any])
...
// ExecuteTransaction types

@js.native
trait ExecuteTransactionCommandInput extends js.Object {
  val TransactStatements: js.UndefOr[js.Array[ParameterizedStatement]] =
    js.native
  val ClientRequestToken: js.UndefOr[String] = js.native
  val ReturnConsumedCapacity: js.UndefOr[ReturnConsumedCapacity] = js.native
}
...
object ExecuteTransactionCommandInput {
  def apply(
      TransactStatements: js.UndefOr[js.Array[ParameterizedStatement]] =
        js.undefined,
      ClientRequestToken: js.UndefOr[String] = js.undefined,
      ReturnConsumedCapacity: js.UndefOr[ReturnConsumedCapacity] = js.undefined
...
object BatchStatementErrorCodeEnum {
  val AccessDenied =
    "AccessDenied".asInstanceOf[BatchStatementErrorCodeEnum]
  val ConditionalCheckFailed =
    "ConditionalCheckFailed".asInstanceOf[BatchStatementErrorCodeEnum]
  val DuplicateItem =
    "DuplicateItem".asInstanceOf[BatchStatementErrorCodeEnum]
  val InternalServerError =
    "InternalServerError".asInstanceOf[BatchStatementErrorCodeEnum]
  ...
  val RequestLimitExceeded =
    "RequestLimitExceeded".asInstanceOf[BatchStatementErrorCodeEnum]
  val ResourceNotFound =
    "ResourceNotFound".asInstanceOf[BatchStatementErrorCodeEnum]
  val ThrottlingError =
    "ThrottlingError".asInstanceOf[BatchStatementErrorCodeEnum]
  val TransactionConflict =
    "TransactionConflict".asInstanceOf[BatchStatementErrorCodeEnum]
  val ValidationError =
    "ValidationError".asInstanceOf[BatchStatementErrorCodeEnum]
}
