...
@js.native
trait InitializeHandlerArguments[Input <: js.Object] extends js.Any {

  /** User input to a command. Reflects the userland representation of the union
    * of data types the command can effectively handle.
    */
  val input: Input = js.native
}

@js.native
trait InitializeHandlerOutput[Output <: js.Object] extends js.Object {
  val output: Output = js.native
...
trait SerializeHandlerArguments[Input <: js.Object]
  ...
  /** The user input serialized as a request object. The request object is
    * unknown, so you cannot modify it directly. When work with request, you
    * need to guard its type to e.g. HttpRequest with 'instanceof' operand
    *
    * During the build phase of the execution of a middleware stack, a built
    * request may or may not be available.
    */
  val request: js.UndefOr[js.Any] = js.native
}
...
@js.native
trait FinalizeHandlerArguments[Input <: js.Object] extends js.Object {
...
@js.native
trait FinalizeHandlerOutput[Output <: js.Object]
...
@js.native
trait DeserializeHandlerOutput[Output <: js.Object] extends js.Any {

  /** The raw response object from runtime is deserialized to structured output
    * object. The response object is unknown so you cannot modify it directly.
    * When work with response, you need to guard its type to e.g. HttpResponse
    * with 'instanceof' operand.
    *
    * During the deserialize phase of the execution of a middleware stack, a
    * deserialized response may or may not be available
    */
  val response: js.Any = js.native
...
@js.native
trait FinalizeHandler[Input <: js.Object, Output <: js.Object] extends js.Any {

  /** Asynchronously converts an input object into an output object.
    *
    * @param args
    *   An object containing a input to the command as well as any associated or
    *   previously generated execution artifacts.
    */
  def apply(
